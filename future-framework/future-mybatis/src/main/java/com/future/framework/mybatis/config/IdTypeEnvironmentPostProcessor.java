...
import com.future.framework.mybatis.constants.SqlConstants;
import com.future.framework.mybatis.util.JdbcUtils;
...
public class IdTypeEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    private static final List<DbType> INPUT_ID_TYPES = Arrays.asList(DbType.ORACLE, DbType.ORACLE_12C,
