...
/**
 * 部门 Base Query，提供给添加、修改、详细的子 Query 使用
 * 如果子 Query 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class DeptBaseQuery {
    ...
    @ApiModelProperty(value = "状态", required = true, example = "1", notes = "见 CommonStatus 枚举")
