...
import { ElInput, ElPopover, ElDivider, ElScrollbar, ElTabs, ElTabPane, ElPagination } from 'element-plus'
            ...
            <template #append>
                ...
                >
                    ...
                    <ElTabs v-model="currentActiveType" @tab-click="handleClick">
                        <ElTabPane v-for="(pane, index) in tabsList" :key="index" :label="pane.label" :name="pane.name">
