...
const handleChangeStatus = async (row: JobVO) => {
    ...
    message
        ...
        .then(async () => {
            row.status = row.status === InfraJobStatusEnum.NORMAL ? InfraJobStatusEnum.NORMAL : InfraJobStatusEnum.STOP
    ...
    <ContentWrap>
        ...
        >
            ...
            <template #action="{ row }">
                ...
                <el-button link type="primary" v-hasPermi="['infra:job:update']" @click="handleChangeStatus(row)">
                ...
                <el-button link type="primary" v-hasPermi="['infra:job:delete']" @click="delList(row.id, false)">
