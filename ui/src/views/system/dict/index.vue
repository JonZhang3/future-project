...
const { getList: getTypeList, setSearchParams: setTypeSearchParams, delList: delTypeList } = typeMethods
...
const { getList: getDataList, setSearchParams: setDataSearchParams, delList: delDataList } = dataMethods
    ...
    <div class="flex">
        <el-card class="w-1/2 dict" :gutter="12" shadow="always">
            ...
            >
                ...
                <template #action="{ row }">
                    <el-button link type="primary" v-hasPermi="['system:dict:update']" @click="handleTypeUpdate(row)">
