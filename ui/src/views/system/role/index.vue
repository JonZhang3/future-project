...
import { ElForm, ElFormItem, ElInput, ElSelect, ElOption, ElMessage, ElTree, ElCard, ElSwitch } from 'element-plus'
...
import type { PermissionAssignRoleDataScopeReqVO, PermissionAssignRoleMenuReqVO } from '@/api/system/permission/types'
...
<template>
    ...
    <Dialog v-model="dialogScopeVisible" :title="dialogScopeTitle" max-height="600px">
        <el-form :model="dataScopeForm">
            ...
            <el-form-item
                label="权限范围"
                v-if="actionScopeType === 'menu' || dataScopeForm.dataScope === SystemDataScopeEnum.DEPT_CUSTOM"
            >
