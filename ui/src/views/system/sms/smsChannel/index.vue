...
<template>
    ...
    <ContentWrap>
        ...
        >
            ...
            <template #action="{ row }">
                <el-button link type="primary" v-hasPermi="['system:sms-channel:update']" @click="handleUpdate(row)">
                    <Icon icon="ep:edit" class="mr-1px" /> {{ t('action.edit') }}
                </el-button>
                <el-button link type="primary" v-hasPermi="['system:sms-channel:update']" @click="handleDetail(row)">
