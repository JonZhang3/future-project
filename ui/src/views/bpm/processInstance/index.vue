...
<template>
    ...
    <ContentWrap>
        ...
        >
            ...
            <template #action="{ row }">
                <el-button link type="primary" v-hasPermi="['bpm:process-instance:query']" @click="handleDetail(row)">
                    <Icon icon="ep:view" class="mr-1px" /> {{ t('action.detail') }}
                </el-button>
                <el-button link type="primary" v-hasPermi="['bpm:process-instance:cancel']" @click="handleCancel(row)">
