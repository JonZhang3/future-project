...
public class RoleController {
    ...
    public R createRole(@Valid @RequestBody RoleCreateQuery query) {
    ...
    public R updateRole(@Valid @RequestBody RoleUpdateQuery query) {
    ...
    @ApiOperation("修改角色状态")
    @PreAuthorize("@ss.hasPermission('system:role:update')")
    public R updateRoleStatus(@Valid @RequestBody RoleUpdateStatusReqVO reqVO) {
    ...
    public R deleteRole(@RequestParam("id") Long id) {
    ...
    public R getRole(@RequestParam("id") Long id) {
